...
const testimonials = [
    { name: "Name", quote: "Thank you!! And thanks so much for your help today! The temple should be recommending you to mitzvah families because I was so not stressed knowing you were handling everything!" },
    { name: "Name", quote: "This is a review. This is a review. This is a review. This is a review. This is a review. "},
    { name: "Name", quote: "This is a review. This is a review. "},
    { name: "Name", quote: "This is a review. This is a review. This is a review. This is a review. "},
    { name: "Name", quote: "This is a review. This is a review. This is a review. This is a review. This is a review. This is a review."}
]
...
function Reviews() {
    ...
    return (
        <section id="reviews" className="reviews main-padding my-20">
            ...
            <h2 className="font-semibold sm:text-[20px] text-[16px] pl-3 mb-5">Hear What Our Happy Clients Have to Say</h2>
