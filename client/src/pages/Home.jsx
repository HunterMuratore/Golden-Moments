...
function Home() {
    return (
        <section id="home" className="home text-center mt-5 py-20">
            ...
            <a href="mailto:info@goldenmomentsnj.com?subject=Inquiry" target="_blank" rel="noopener noreferrer"><button className="my-btn my-7 sm:my-10">Contact <i className="fas fa-envelope"></i></button></a>
